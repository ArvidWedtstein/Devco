 ...
 */
function devco_custom_colors_css() {
	...
	/**
	 * Filters devco default saturation level.
	 *
	 * @since devco 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'devco_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filters devco default selection saturation level.
	 *
	 * @since devco 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'devco_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filters devco default lightness level.
	 *
	 * @since devco 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'devco_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filters devco default hover lightness level.
	 *
	 * @since devco 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'devco_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filters devco default selection lightness level.
	 *
	 * @since devco 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'devco_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters devco custom colors CSS.
	 *
	 * @since devco 1.0
	 *
	 ...
	 */
	return apply_filters( 'devco_custom_colors_css', $theme_css, $primary_color, $saturation );
}
